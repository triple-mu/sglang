...
_SPECS: tuple[tuple[str, KernelBackend, str, frozenset, str], ...] = (
    ...
    (
        "diffusion.group_norm_silu_4d",
        KernelBackend.JIT,
        "norm.group_norm_silu_twopass_jit:group_norm_silu_4d",
        _CUDA,
        "Channels-last two-pass GroupNorm(+SiLU), 4D (C++ JIT, Triton fallback).",
    ),
    (
    ...
    (
        "diffusion.group_norm_silu_rows",
        KernelBackend.JIT,
        "norm.group_norm_silu_twopass_jit:group_norm_silu_rows",
        _CUDA,
        "Channels-last two-pass GroupNorm(+SiLU) rows (C++ JIT, Triton fallback).",
    ),
    (
    ...
    (
        "diffusion.rmsnorm_indexed_scale_shift",
        KernelBackend.JIT,
        "norm.rmsnorm_indexed_modulate_jit:rmsnorm_indexed_scale_shift",
        _CUDA,
        "RMSNorm + indexed adaLN scale/shift over merged w_eff rows.",
    ),
    (
        "diffusion.rmsnorm_indexed_scale_shift",
        KernelBackend.TRITON,
        "norm.rmsnorm_indexed_modulate_triton:rmsnorm_indexed_scale_shift",
        _CUDA,
        "RMSNorm + indexed adaLN scale/shift (Triton fallback).",
    ),
    (
        "diffusion.gate_residual_rmsnorm_indexed_scale_shift",
        KernelBackend.JIT,
        "norm.rmsnorm_indexed_modulate_jit:gate_residual_rmsnorm_indexed_scale_shift_",
        _CUDA,
        "Indexed gated-residual add + RMSNorm + indexed scale/shift.",
    ),
    (
        "diffusion.gate_residual_rmsnorm_indexed_scale_shift",
        KernelBackend.TRITON,
        "norm.rmsnorm_indexed_modulate_triton:gate_residual_rmsnorm_indexed_scale_shift_",
        _CUDA,
        "Indexed gated-residual add + RMSNorm + scale/shift (Triton fallback).",
    ),
    (
        "diffusion.rmsnorm_indexed_scale_shift_bitexact",
        KernelBackend.JIT,
        "norm.rmsnorm_indexed_modulate_jit:rmsnorm_indexed_scale_shift_bitexact",
        _CUDA,
        "Bit-exact (aten-order) RMSNorm + indexed adaLN scale/shift.",
    ),
    (
        "diffusion.gate_residual_rmsnorm_indexed_scale_shift_bitexact",
        KernelBackend.JIT,
        "norm.rmsnorm_indexed_modulate_jit:gate_residual_rmsnorm_indexed_scale_shift_bitexact_",
        _CUDA,
        "Bit-exact indexed gated-residual add + RMSNorm + scale/shift.",
    ),
    (
        "diffusion.residual_rmsnorm_cast",
        KernelBackend.JIT,
        "norm.residual_rmsnorm_cast_jit:fused_residual_rmsnorm_cast_",
        _CUDA,
        "In-place fp32 residual add + RMSNorm + autocast-dtype cast.",
    ),
    (
        "diffusion.scale_residual_norm_scale_shift",
    ...
    (
        "diffusion.indexed_gate_bf16",
        KernelBackend.JIT,
        "modulate.indexed_gate_jit:indexed_gate_bf16",
        _CUDA,
        "Indexed gated residual x + gate[idx] * other, exact bf16 chain "
        "(cpp-jit, Triton fallback).",
    ),
    (
        "diffusion.indexed_gate_bf16",
        KernelBackend.TRITON,
        "modulate.indexed_modulation_triton:indexed_gate_bf16",
        _CUDA,
        "Indexed gated residual x + gate[idx] * other, exact bf16 chain.",
    ),
    (
        "diffusion.indexed_scale_shift",
        KernelBackend.JIT,
        "modulate.indexed_modulation_jit:indexed_scale_shift_bf16_",
        _CUDA,
        "Bit-exact in-place indexed adaLN modulate x * (1 + scale[idx]) + shift[idx].",
    ),
    (
        "diffusion.indexed_scale_shift",
        KernelBackend.TRITON,
        "modulate.indexed_modulation_triton:indexed_scale_shift_bf16_",
        _CUDA,
        "In-place indexed adaLN modulate (Triton fallback).",
    ),
    (
        "diffusion.indexed_scale_shift_fp32_out",
        KernelBackend.TRITON,
        "modulate.indexed_modulation_triton:indexed_scale_shift_bf16_to_fp32",
        _CUDA,
        "Indexed adaLN modulate fused with the fp32 widening cast.",
    ),
    (
    ...
    (
        "diffusion.silu_mul_per_token_quant_fp8",
        KernelBackend.JIT,
        "activation.silu_mul_quant_jit:fused_silu_mul_per_token_quant_fp8",
        _CUDA,
        "Packed SwiGLU + per-token FP8 quant (C++ JIT, Triton fallback).",
    ),
    (
        "diffusion.silu_mul_per_token_quant_fp8",
        KernelBackend.TRITON,
        "activation.silu_mul_quant_triton:fused_silu_mul_per_token_quant_fp8",
        _CUDA,
        "Packed SwiGLU + per-token FP8 quant, bitwise vs the separated chain.",
    ),
    (
        "diffusion.bias_silu",
        KernelBackend.TRITON,
    ...
    (
        "diffusion.usp_merge_heads_per_token_quant_fp8",
        KernelBackend.TRITON,
        "layout.usp_merge_quant_triton:usp_merge_heads_per_token_quant_fp8",
        _CUDA,
        "USP output head merge + per-token FP8 quant, bitwise vs the separated chain.",
    ),
    (
        "diffusion.usp_merge_heads_per_token_quant_fp8",
        KernelBackend.JIT,
        "layout.usp_merge_quant_jit:usp_merge_heads_per_token_quant_fp8",
        _CUDA,
        "USP output head merge + per-token FP8 quant (C++ JIT, Triton fallback).",
    ),
    (
        "diffusion.merge_two_sources_per_token_quant_fp8",
        KernelBackend.TRITON,
        "layout.usp_merge_quant_triton:merge_two_sources_per_token_quant_fp8",
        _CUDA,
        "Two-source head merge + per-token FP8 quant (IPC output form).",
    ),
    (
        "diffusion.merge_two_sources_per_token_quant_fp8",
        KernelBackend.JIT,
        "layout.usp_merge_quant_jit:merge_two_sources_per_token_quant_fp8",
        _CUDA,
        "Two-source head merge + per-token FP8 quant (C++ JIT, Triton fallback).",
    ),
    (
        "diffusion.pack_qkv_destination_major",
        KernelBackend.JIT,
        "layout.ulysses_qkv_jit:pack_qkv_destination_major",
        _CUDA,
        "Ulysses destination-major QKV pack (cpp-jit, Triton fallback).",
    ),
    (
        "diffusion.pack_qkv_destination_major",
        KernelBackend.TRITON,
...
_EXPORTS: dict[str, str] = {
    ...
    "can_use_group_norm_silu_4d": "norm.group_norm_silu_twopass_jit",
    "can_use_group_norm_silu_rows": "norm.group_norm_silu_twopass_jit",
    "group_norm_silu_4d": "norm.group_norm_silu_twopass_jit",
    "group_norm_silu_rows": "norm.group_norm_silu_twopass_jit",
    ...
    "can_use_fused_residual_rmsnorm_cast": "norm.residual_rmsnorm_cast_jit",
    "fused_residual_rmsnorm_cast_": "norm.residual_rmsnorm_cast_jit",
    "can_use_gate_residual_rmsnorm_indexed_scale_shift_bitexact_cuda": "norm.rmsnorm_indexed_modulate_jit",
    "can_use_gate_residual_rmsnorm_indexed_scale_shift_cuda": "norm.rmsnorm_indexed_modulate_jit",
    "can_use_rmsnorm_indexed_scale_shift_bitexact_cuda": "norm.rmsnorm_indexed_modulate_jit",
    "can_use_rmsnorm_indexed_scale_shift_cuda": "norm.rmsnorm_indexed_modulate_jit",
    "gate_residual_rmsnorm_indexed_scale_shift_": "norm.rmsnorm_indexed_modulate_jit",
    "gate_residual_rmsnorm_indexed_scale_shift_bitexact_": "norm.rmsnorm_indexed_modulate_jit",
    "gate_residual_rmsnorm_indexed_scale_shift_cuda_": "norm.rmsnorm_indexed_modulate_jit",
    "rmsnorm_indexed_scale_shift": "norm.rmsnorm_indexed_modulate_jit",
    "rmsnorm_indexed_scale_shift_bitexact": "norm.rmsnorm_indexed_modulate_jit",
    "rmsnorm_indexed_scale_shift_cuda": "norm.rmsnorm_indexed_modulate_jit",
    ...
    "can_use_indexed_gate_bf16_cuda": "modulate.indexed_gate_jit",
    "indexed_gate_bf16": "modulate.indexed_gate_jit",
    "indexed_gate_bf16_": "modulate.indexed_gate_jit",
    "can_use_indexed_scale_shift_cuda": "modulate.indexed_modulation_jit",
    "indexed_scale_shift_bf16_": "modulate.indexed_modulation_jit",
    "indexed_scale_shift_bf16_cuda": "modulate.indexed_modulation_jit",
    "indexed_scale_shift_bf16_to_fp32": "modulate.indexed_modulation_triton",
    ...
    "can_use_fused_silu_mul_per_token_quant_fp8": "activation.silu_mul_quant_jit",
    "can_use_silu_mul_quant_cuda": "activation.silu_mul_quant_jit",
    "fused_silu_mul_per_token_quant_fp8": "activation.silu_mul_quant_jit",
    "silu_mul_quant_cuda": "activation.silu_mul_quant_jit",
    ...
    "can_use_pack_qkv_destination_major_cuda": "layout.ulysses_qkv_jit",
    "pack_qkv_destination_major": "layout.ulysses_qkv_jit",
    "can_use_usp_merge_heads": "layout.usp_relayout_jit",
    "usp_merge_heads": "layout.usp_relayout_jit",
    "can_use_merge_two_sources_per_token_quant_fp8": "layout.usp_merge_quant_jit",
    "can_use_usp_merge_heads_per_token_quant_fp8": "layout.usp_merge_quant_jit",
    "merge_two_sources_per_token_quant_fp8": "layout.usp_merge_quant_jit",
    "usp_merge_heads_per_token_quant_fp8": "layout.usp_merge_quant_jit",
