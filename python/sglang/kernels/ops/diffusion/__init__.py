...
_SPECS: tuple[tuple[str, KernelBackend, str, frozenset, str], ...] = (
    ...
    (
        "diffusion.minimax_h3_vae_assemble_tiles",
        KernelBackend.JIT,
        "layout.minimax_h3_vae_output_jit:minimax_h3_vae_assemble_tiles",
        _CUDA_SM100_PLUS,
        "MiniMax-H3 VAE tile blend + crop + place; bit-exact vs the eager chain.",
    ),
    (
        "diffusion.minimax_h3_vae_temporal_blend_write",
        KernelBackend.JIT,
        "layout.minimax_h3_vae_output_jit:minimax_h3_vae_temporal_blend_write",
        _CUDA_SM100_PLUS,
        "MiniMax-H3 VAE temporal window blend + write; bit-exact vs the eager chain.",
    ),
    (
        "diffusion.minimax_h3_vae_denorm_clamp",
        KernelBackend.JIT,
        "layout.minimax_h3_vae_output_jit:minimax_h3_vae_denorm_clamp",
        _CUDA_SM100_PLUS,
        "MiniMax-H3 VAE RGB de-normalization + clamp; bit-exact vs the eager chain.",
    ),
    (
...
_EXPORTS: dict[str, str] = {
    ...
    "minimax_h3_vae_assemble_tiles": "layout.minimax_h3_vae_output_jit",
    "minimax_h3_vae_denorm_clamp": "layout.minimax_h3_vae_output_jit",
    "minimax_h3_vae_temporal_blend_write": "layout.minimax_h3_vae_output_jit",
